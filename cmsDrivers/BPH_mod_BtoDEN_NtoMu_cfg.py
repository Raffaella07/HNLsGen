...
#process.MuElectronFilter = cms.EDFilter("MCParticlePairFilter",
#    MaxEta = cms.untracked.vdouble(1.6, 2.45),   # first is muon, second is electron
#    MinEta = cms.untracked.vdouble(-1.6, -2.45), # muon cuts are higher because the muon triggers the event
#    MinPt = cms.untracked.vdouble(5., 2.7),
...
process.SingleMuFilter = cms.EDFilter("PythiaFilter", # using PythiaFilter instead of MCParticleFilter because the particleID is taken in abs value
    ...
    MotherID = cms.untracked.int32(9900015), # require muon to come from HNL decay
    #SisterID = cms.untracked.int32(9900015), # require HNL sister... doesn't seem to do anything
)
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            # decay to HNL, dirac, and decay also HNL   ### mu+electron channel
            user_decay_embedded = cms.vstring("\nAlias myB+ B+\nAlias myB- B-\nAlias myD0 D0\nAlias myAntiD0 anti-D0\nChargeConj myB+ myB-\nChargeConj myD0 myAntiD0\nChargeConj hnl anti_hnl\nDecay myB-\n1.0     myD0    e-    anti_hnl    PHSP;\nEnddecay\nCDecay myB+\n\nDecay myD0\n1.0    K-    pi+    PHSP;\nEnddecay\nCDecay myAntiD0\nDecay anti_hnl\n1.0     mu+    pi-    PHSP;\nEnddecay\nCDecay hnl\n\nEnd\n")
